...
class CLIPVisionCfg:
    ...
    # KoPE specific settings
    kope_mode: bool = False
    enable_kope: bool = True
...
def _build_vision_tower(
    ...
    if vision_cfg.timm_model_name:
    ...
    elif vision_cfg.kope_mode:
        from .transformer_kope import VisionTransformer as VisionTransformerKoPE
        ...
        visual = VisionTransformerKoPE(
            ...
            # KoPE related
            enable_kope=vision_cfg.enable_kope,
            kope_vo_rotation=vision_cfg.kope_vo_rotation,
            kope_mix=vision_cfg.kope_mix,
            kope_mix_init_gain=vision_cfg.kope_mix_init_gain,
            kope_mix_phase_norm=vision_cfg.kope_mix_phase_norm,
            checkpoint_rotation=vision_cfg.checkpoint_rotation,
            kope_coupling_gamma=vision_cfg.kope_coupling_gamma,
            kope_coupling_qknorm_learn=vision_cfg.kope_coupling_qknorm_learn,
            kope_learn_gamma=vision_cfg.kope_learn_gamma,
            kope_base=vision_cfg.kope_base,
        )
