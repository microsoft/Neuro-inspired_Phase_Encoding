...
from simdinov2.data.transforms import make_classification_eval_transform
from simdinov2.eval.metrics import AccuracyAveraging, build_topk_accuracy_metric
...
from simdinov2.eval.utils import ModelWithNormalize, evaluate, extract_features
...
class KnnModule(torch.nn.Module):
    ...
    def __init__(self, train_features, train_labels, nb_knn, T, device, num_classes=1000):
        ...
        self.global_size = dist.get_global_size()
