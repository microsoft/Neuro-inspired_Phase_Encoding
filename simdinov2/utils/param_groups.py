...
def get_params_groups_with_decay(model, lr_decay_rate=1.0, patch_embed_lr_mult=1.0, phase_coupling_lr_mult=1.0):
    # to deal with potential torch.compile issues
    ...
    for name, param in model.named_parameters():
        ...
        if "phase_coupling" in name:
            d.update({"lr_multiplier": d["lr_multiplier"] * phase_coupling_lr_mult})
